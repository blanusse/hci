...
const modos = [
   ...
   { value: 'fiesta', label: 'Fiesta', icon: `<path d="M5.8 11.3 2 22l10.7-3.79"/><path d="M4 3h.01"/><path d="M22 8h.01"/><path d="M15 2h.01"/><path d="M22 20h.01"/><path d="m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12c.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L14 10"/><path d="m22 13-.82-.33c-.86-.34-1.82.2-1.98 1.11c-.11.7-.72 1.22-1.43 1.22H17"/><path d="m11 2 .33.82c.34.86-.2 1.82-1.11 1.98C9.52 4.9 9 5.52 9 6.23V7"/><path d="M11 13c1.93 1.93 2.83 4.17 2 5-.83.83-3.07-.07-5-2-1.93-1.93-2.83-4.17-2-5 .83-.83 3.07.07 5 2z"/>` },
...
<style scoped>
.hel-preview { display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100px; height: 100px; border-radius: 50%; margin: 0 auto 20px; transition: background-color 0.3s, border-color 0.3s; border: 3px solid var(--border); color: var(--text); gap: 4px; background: var(--bg); color: var(--color-icon); }
.hel-preview.normal { background: #e0f0ff; border-color: #60b8ff; color: #1a7cc9; }
.hel-preview.fiesta { background: #fdf0ff; border-color: #c084fc; color: #7e22ce; }
.hel-preview.vacaciones { background: #fff8e0; border-color: #fbbf24; color: #b45309; }
